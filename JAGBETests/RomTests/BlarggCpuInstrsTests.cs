...
namespace JAGBETests.RomTests
{
    ...
    public class BlarggCpuInstrsTests
    {
        ...
        public void Cpu_Instrs_01() =>
            TestDisplayOut(baseTestPath + "01-special.gb", "bob4OkiQuQnncCCWmjPnNAth9isO5lXBF9S6lO0vSB4=");
        ...
        public void Cpu_Instrs_04() =>
            TestDisplayOut(baseTestPath + "04-op r,imm.gb", "sJE9ieevr0n64hiMKAdQ0tbbpTw9nRnUfIHMazvBSAQ=");

        [TestMethod]
        public void Cpu_Instrs_05() =>
            TestDisplayOut(baseTestPath + "05-op rp.gb", "shUu/ROKPI7PZ5Xw/9D6m0eX2J6g9IqI1eSrMTHm+Lk=");

        [TestMethod]
        public void Cpu_Instrs_06() =>
            TestDisplayOut(baseTestPath + "06-ld r,r.gb", "u8jHutord6tOSUK3M7tTVR/jY+Nm7j+JptYIe8ozTU8=");
        ...
        public void Cpu_Instrs_08() =>
            TestDisplayOut(baseTestPath + "08-misc instrs.gb", "pDNJyFIFGShHqjb6R73Yg974+NBN9oqoHyFzF7k9xPY=");

        [TestMethod]
        public void Cpu_Instrs_09() =>
            TestDisplayOut(baseTestPath + "09-op r,r.gb", "j5qZ3AqOkFxEK83Z7J/00p9pvsgbNqDcZDOB1R58+x4=");

        [TestMethod]
        public void Cpu_Instrs_10() =>
            TestDisplayOut(baseTestPath + "10-bit ops.gb", "lwPf+SpOoWkPqLdXhMH7vv922kwuswR3pQCy/Cm3sZA=");

        [TestMethod]
        public void Cpu_Instrs_11() =>
            TestDisplayOut(baseTestPath + "11-op a,(hl).gb", "EOxaj0QrghgxcscFQUHsv5v5+WYglfg/JTHl6oy7PnI=");
    }
}
