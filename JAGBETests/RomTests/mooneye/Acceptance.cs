...
namespace JAGBETests.RomTests.mooneye
{
    ...
    public class AcceptanceTests
    {
        ...
        private const string GenericSuccessSha = "ct/pSMvekPxIlT/NLHziuq1NDmhtjOC6zt2GF3aDBrs=";
        ...
        public class Bits
        {
            ...
            [TestMethod]
            public void Mem_oam() => TestDisplayOut(Path + "mem_oam.gb", GenericSuccessSha, true);
            ...
            public void Unused_hwio_GS() =>
                TestDisplayOut(Path + "unused_hwio-GS.gb", GenericSuccessSha, true);
        }

        [TestClass]
        [TestCategory("mooneye-gb_hwtests/acceptance/interrupts")]
        public class Interrupts
        {
            private const string Path = BasePath + "interrupts/";

            [TestMethod]
            public void Ie_push() => TestDisplayOut(Path + "ie_push.gb", GenericSuccessSha, true);
        }
        ...
        public void Boot_hwio_dmgABCXmgb() => TestDisplayOut(BasePath + "boot_hwio-dmgABCXmgb.gb",
                GenericSuccessSha, false, "ENFHl86MMZbEQYluddLwwHZCaKb1tSDmRjWr8Dtc9Uc=");
        ...
        public void DI_timing_GS() => TestDisplayOut(BasePath + "di_timing-GS.gb",
                GenericSuccessSha, true, "Z/A8HucoeyOxrdLafSqS+mpn5CkHhdA4FHDukzLRiX8=");
        ...
        public void Halt_ime0_ei() => TestDisplayOut(BasePath + "halt_ime0_ei.gb",
            GenericSuccessSha, true, "AnWWPp+xnxUr2GjoSXOUdV7oZ5EPH4savUqemGjbhOY=");
        ...
        [TestMethod]
        public void Ret_cc_timing() => TestDisplayOut(BasePath + "ret_cc_timing.gb", GenericSuccessSha, true);

        [TestMethod]
        public void Ret_timing() => TestDisplayOut(BasePath + "ret_timing.gb", GenericSuccessSha, true);
        ...
        [TestMethod]
        public void Reti_timing() => TestDisplayOut(BasePath + "reti_timing.gb", GenericSuccessSha, true);
