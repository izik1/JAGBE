...
namespace JAGBETests.RomTests.mooneye
{
    ...
    public class Timer
    {
        ...
        [TestMethod]
        public void Rapid_toggle() =>
            TestDisplayOut(BasePath + "rapid_toggle.gb", "", false, "B1VQiIvWUVF9q5TPxWNfBNIEObZYWPhndpl7QhvgstE=");

        [TestMethod]
        public void Tim00() => TestDisplayOut(BasePath + "tim00.gb", "", false, "kqHHFZX8+VTWPm387UNr3XVsekc9IZ57pmY76m8MBdQ=");

        [TestMethod]
        public void Tim00_div_trigger() =>
            TestDisplayOut(BasePath + "tim00_div_trigger.gb", "", false, "kqHHFZX8+VTWPm387UNr3XVsekc9IZ57pmY76m8MBdQ=");
        ...
        [TestMethod]
        public void Tima_reload() =>
            TestDisplayOut(BasePath + "tima_reload.gb", "", false, "iBBMHwQQlHbfhxgyQcBnu4wdjc3p8kcdtrGND6+VVSc=");

        [TestMethod]
        public void Tima_write_reloading() =>
            TestDisplayOut(BasePath + "tima_write_reloading.gb", "", false, "rCJEsbbvrCoNqNrYbDpj2ZaG6mzg5c17RQuMp3B6zbs=");

        [TestMethod]
        public void Tma_write_reloading() =>
            TestDisplayOut(BasePath + "tma_write_reloading.gb", "", false, "lVh/1pAZ+jJHdn4m6v71r2dlFjh9Ha7wp9XRVmi92h0=");
    }
}
