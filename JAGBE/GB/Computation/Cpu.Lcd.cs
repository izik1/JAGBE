    ...
    internal sealed partial class Cpu
    {
        ...
        private static class Lcd
        {
            ...
            public static void Tick(GbMemory mem)
            {
                ...
                else if (mem.lcdMemory.LY == 144)
                {
                    ...
                    else
                    {
                        ...
                        else if (mem.lcdMemory.cy == DelayStep * 113)
                        {
                            mem.lcdMemory.LY++;
                            mem.lcdMemory.cy = 0;
                        }
            ...
            private static void RenderLine(GbMemory mem)
            {
                ...
                else if (mem.lcdMemory.cy <= DelayStep * 10)
                {
                    if (mem.lcdMemory.cy == DelayStep)
                    {
                    ...
                    while (mem.lcdMemory.ObjAttriMemOffset < (mem.lcdMemory.cy / DelayStep) * 2)// 2*sprite(4 bytes)
                    {
                ...
                else if (mem.lcdMemory.cy == DelayStep * 11)
                {
                ...
                else if (mem.lcdMemory.cy < DelayStep * 63)
                {
